...
getJasmineRequireObj().Env = function (j$) {
  ...
  function Env(options) {
    ...
    this.setDefaultSpyStrategy = function (defaultStrategyFn) {
      ...
      runnableResources[currentRunnable().id].defaultStrategyFn =
        defaultStrategyFn
    }
      ...
      compare: function (actualPromise, expectedValue) {
        ...
        return actualPromise.then(
          ...
          function (actualValue) {
            if (
              util.equals(actualValue, expectedValue, customEqualityTesters)
            ) {
              return {
                pass: true,
                message: prefix(true) + '.',
...
getJasmineRequireObj().toBeRejectedWithError = function (j$) {
  ...
  function getExpectedFromArgs(arg1, arg2) {
    ...
    return {
      ...
      printValue:
        j$.fnNameFor(error) +
        (typeof message === 'undefined' ? '' : ': ' + j$.pp(message)),
    }
  }
    ...
    return {
      compare: function (actual, expected) {
        ...
        if (typeof expected === 'object') {
          result.message =
            util.buildFailureMessage('toBe', result.pass, actual, expected) +
            tip
        }
